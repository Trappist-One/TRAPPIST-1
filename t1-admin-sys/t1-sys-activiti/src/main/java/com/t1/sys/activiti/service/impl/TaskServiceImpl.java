...
import com.t1.sys.activiti.dto.CommentDto;
import com.t1.sys.activiti.dto.LeaveDto;
import com.t1.sys.activiti.dto.TaskCheckDto;
import com.t1.sys.activiti.dto.TaskDto;
import com.t1.sys.activiti.entity.Leave;
import com.t1.sys.activiti.mapper.CommonEntityBusinessMapper;
import com.t1.sys.activiti.service.LeaveService;
import com.t1.sys.activiti.util.BusinessProcessingUtil;
import com.t1.common.constant.CommonConstants;
import com.t1.common.enums.ActivitiBusinessSql;
...
@Service
@AllArgsConstructor
public class TaskServiceImpl implements com.t1.sys.activiti.service.TaskService {
    ...
    @Override
    public IPage list(Map<String, Object> params, String username) {
    ...
    @Override
    public IPage historyList(Map<String, Object> params, String username) {
        NativeHistoricTaskInstanceQuery nativeHistoricTaskInstanceQuery = historyService.createNativeHistoricTaskInstanceQuery();
        nativeHistoricTaskInstanceQuery.parameter("currentUser",username);
