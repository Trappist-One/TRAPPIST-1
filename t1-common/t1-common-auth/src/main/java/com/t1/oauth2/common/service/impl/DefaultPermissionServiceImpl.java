...
public abstract class DefaultPermissionServiceImpl {
     ...
     * @return
     */
    public abstract List<Menu> findMenuByRoleCodes(String roleCodes);
    ...
    public boolean hasPermission(Authentication authentication, String requestMethod, String requestURI) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (CommonConstants.ADMIN_USER_NAME.equals(username)) {
                return true;
            }
            ...
            List<Menu> menuList = findMenuByRoleCodes(roleCodes);
            for (Menu menu : menuList) {
                if (StringUtils.isNotEmpty(menu.getPath()) && antPathMatcher.match(menu.getPath(), requestURI)) {
