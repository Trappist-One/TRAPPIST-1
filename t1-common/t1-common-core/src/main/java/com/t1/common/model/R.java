...
import com.t1.common.utils.MessageUtil;
import lombok.*;
...
public class R<T> implements Serializable {
    ...
    public static <T> R<T> success(String code, String... params) {
    ...
    public static <T> R<T> restData(T data, int code, String msg, long total) {
        R<T> apiData = new R<>();
