package com.t1.common.feign;

import com.t1.common.entity.User;
import com.t1.common.constant.ServiceNameConstants;
import com.t1.common.feign.fallback.UserServiceFallbackFactory;
 ...
 */
@FeignClient(name = ServiceNameConstants.T1_SYSTEM_SERVICE, fallbackFactory = UserServiceFallbackFactory.class, decode404 = true)
public interface UserService {
     ...
     * @return
     */
    @GetMapping(value = "/users-anon/name/{username}")
    ...
    LoginAppUser findLoginAppUserByUsername(@RequestParam("username") String username);
