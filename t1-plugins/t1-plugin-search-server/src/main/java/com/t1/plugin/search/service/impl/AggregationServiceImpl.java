...
import com.t1.common.search.model.AggItemVo;
import com.t1.plugin.search.service.IAggregationService;
            ...
            AggregationBuilders
                    ...
                    .subAggregation(
                            ...
                            AggregationBuilders
                                    ...
                                    .format(CommonConstants.DATETIME_FORMAT)
                                    //时区相差8小时
                                    .timeZone(ZoneId.of(CommonConstants.TIME_ZONE_GMT8))
                                    .minDocCount(0L)
                                    .extendedBounds(new LongBounds(
                                            curDateTime.minusDays(1).format(DateTimeFormatter.ofPattern(CommonConstants.DATETIME_FORMAT)),
                                            curDateTime.format(DateTimeFormatter.ofPattern(CommonConstants.DATETIME_FORMAT))
                                    ))
                                    .subAggregation(
                                            AggregationBuilders
                                                    .cardinality("uv")
            ...
            AggregationBuilders
                    ...
                    .subAggregation(
                            ...
                            AggregationBuilders
                                    ...
                                    .format(CommonConstants.DATE_FORMAT)
                                    //时区相差8小时
                                    .timeZone(ZoneId.of(CommonConstants.TIME_ZONE_GMT8))
                                    .minDocCount(0L)
                                    .extendedBounds(new LongBounds(
                                            localDate.minusDays(6).format(DateTimeFormatter.ofPattern(CommonConstants.DATE_FORMAT)),
                                            localDate.format(DateTimeFormatter.ofPattern(CommonConstants.DATE_FORMAT))
                                    ))
                                    .subAggregation(
                                            AggregationBuilders
                                                    .cardinality("uv")
