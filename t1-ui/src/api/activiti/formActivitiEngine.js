...
export function listFormActivitiEngine(query) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/list',
    method: 'get',
    params: query
  })
}
...
export function getFormActivitiEngine(id) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/' + id,
    method: 'get'
  })
}
...
export function fetchFormActivitiEngine(code) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/fetchFormActivitiEngine/' + code,
    method: 'get'
  })
}
...
export function addFormActivitiEngine(data) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/save',
    method: 'post',
    data: data
  })
}
...
export function editFormActivitiEngine(data) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/update',
    method: 'put',
    data: data
  })
}
...
export function delFormActivitiEngine(id) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/remove/' + id,
    method: 'delete'
  })
}
...
export function editFormActivitiEngineDesign(data) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/design/update',
    method: 'put',
    data: data
  })
}
...
export function selectFormActivitiEngineDesign(id) {
  return request({
    url: Api.API_SYSTEM + '/activiti/FormActivitiEngine/design/select/' + id,
    method: 'get',
  })
}
