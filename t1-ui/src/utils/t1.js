...
export function download(fileName) {
	window.location.href = baseURL +  "/" + Api.API_AUTH +  "/common/download?fileName=" + encodeURI(fileName) + "&delete=" + true;
}
...
export function newPath(path) {
  return baseURL + '/' + Api.API_SYSTEM + path;
}

export function preview(path) {
  const previewUrl = 'http://' + location.host + baseURL + '/' + Api.API_SYSTEM + path
