<template>
  <div class="login">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="validCode" >
            <el-input v-model="loginForm.validCode" type="text" auto-complete="off" placeholder="验证码" maxlength="4" @keyup.enter.native="handleLogin">
    ...
    <div class="el-login-footer">
      <span>Copyright © 2021-2022  t1团队 All Rights Reserved.</span>
    </div>
  </div>
</template>
  ...
  methods: {
    getCode() {
      getCodeImg().then(res => {
        ...
        this.loginForm.deviceId = res.data.deviceId;
      });
    },
    getCookie() {
