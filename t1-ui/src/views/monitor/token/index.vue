    ...
    <el-dialog title="令牌详细" :visible.sync="open" width="700px">
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="令牌：">{{ form.tokenValue }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="授权类型：">{{ form.grantType }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所属应用：">{{ form.clientId }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="过期时间：">{{ form.expiresIn }}</el-form-item>
          </el-col>
        </el-row>
      </el-form>
