...
export default {
  ...
  methods: {
    ...
    /** 流程图按钮操作 */
    handleImg(row) {
      this.imgUrl = process.env.VUE_APP_BASE_API + "/" + Api.API_SYSTEM + `/activiti/process/resource?procInsId=` + row.deploymentId + '&procDefId=' + row.processonDefinitionId + '&resType=image',
