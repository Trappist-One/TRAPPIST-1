...
import com.t1.biz.intelligent.dto.FormExtendDesignDto;
import com.t1.biz.intelligent.dto.JsonMode;
...
import com.t1.biz.intelligent.mapper.ControlStewardMapper;
import com.t1.biz.intelligent.mapper.DataConfMapper;
import com.t1.biz.intelligent.mapper.FormExtendDesignMapper;
import com.t1.biz.intelligent.mapper.FormExtendMapper;
import com.t1.biz.intelligent.service.FormExtendDesignService;
...
public class FormExtendDesignServiceImpl implements FormExtendDesignService {
    ...
    @Override
    public int insert(FormExtendDesignDto formExtendDesignDto, String username) {
        //:fixme 校验
        ...
        for (int i = 0; i < controlFields.size(); ++i) {
           ...
           if(ObjectUtil.isNotEmpty(controlSteward)){
               ...
               ProcessJsonMode.put("create_by", username);
        ...
        formExtendMapper.update(new FormExtend()
                ...
                .setUpdateBy(username).setUpdateTime(new Date()),
    ...
    @Override
    public int update(FormExtendDesignDto formExtendDesignDto, String username) {
        //:fixme 校验
        Optional.ofNullable(formExtendDesignDto.getJsonMode()).orElseThrow(()->new NullPointerException("Json数据模型不能为空!"));
        //:todo 初始化局部变量
        JsonMode JsonMode=formExtendDesignDto.getJsonMode();
