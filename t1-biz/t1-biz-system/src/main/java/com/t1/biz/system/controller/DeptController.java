...
import com.t1.biz.system.entity.Dept;
import com.t1.biz.system.entity.RoleDept;
import com.t1.biz.system.service.DeptService;
import com.t1.biz.system.service.RoleDeptService;
import com.t1.biz.system.service.UserService;
import com.t1.biz.system.vo.ResultVo;
...
public class DeptController {
    ...
    public R list(Dept dept) {
        ...
        return R.success(deptList, deptList.size());
    }
    ...
    public R deptTree() {
        ...
        return R.success(deptService.buildTree(deptList, 0));
    }
    ...
    public R roleDeptTree(@PathVariable Integer roleId) {
        ...
        return R.success(ResultVo.builder().result(deptService.buildTree(deptList, 0)).extend(depts).build());
    }
