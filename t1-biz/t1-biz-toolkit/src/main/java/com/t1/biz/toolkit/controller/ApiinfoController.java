...
public class ApiinfoController {
    ...
    public R list(Page page, Apiinfo apiinfo) {
        ...
        return R.success(apiinfoPage.getRecords(), apiinfoPage.getTotal());
    }

    @OperLog("接口查询")
    @GetMapping("/{id}")
    public R getById(@PathVariable("id") Integer id) {
        return R.success(apiinfoService.getById(id));
    }
    ...
    @Transactional
    public R quickSave(@LoginUser(isFull = true) User user, @Validated @RequestBody Apiinfo apiinfo) {
        ...
        if (table != null) {
            ...
            apiinfo.setDeptId(user.getDeptId());
            ...
            if (columnList != null && columnList.size() > 0) {
                ...
                if (StrUtil.contains(type, "新增")) {
                    ...
                    apiinfo1.setDeptId(user.getDeptId());
    ...
    public R remove(@PathVariable("id") Integer[] id) throws Exception {
        return R.success(apiinfoService.removeByIds(Arrays.asList(id)));
    }
