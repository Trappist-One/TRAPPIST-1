...
import com.t1.biz.toolkit.entity.Dataset;
import com.t1.biz.toolkit.service.DatasetService;
...
public class DatasetController {
    ...
    public R list(Page page, Dataset dataset) {
        ...
        return R.success(datasetPage.getRecords(), datasetPage.getTotal());
    }
    ...
    public R getById(@PathVariable("id") Integer id) {
        return R.success(datasetService.getById(id));
    }
    ...
    public R remove(@PathVariable("id") Integer[] id) {
        return R.success(datasetService.removeByIds(Arrays.asList(id)));
    }
